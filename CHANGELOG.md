...
### Added
- Global hotkey (⌘⇧K) to trigger rewrite from anywhere on macOS
- AX-based selected text capture with clipboard fallback for Terminal/Electron apps
...
- Settings: model picker, skip-critique toggle
